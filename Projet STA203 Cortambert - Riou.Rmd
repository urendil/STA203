...
abline(h=ridge_fit$a0[which.min(ridge_fit$a0)],col="red",lty=2)
abline(v=which.min((ridge_fit$a0)),col="red",lty=2)
ridge_fit$a0[which.min(ridge_fit$a0)]
```
